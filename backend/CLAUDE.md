...
src/
  ...
  migrations/             # InitialSchema, SeedDevAdmin (guarded off in production), YagodaFoundation, BootstrapOwner, IndexUserIdentityUser, YagodaCatalog, YagodaSuppliersAndPrices, YagodaIntakesAndPayouts, YagodaTransfers, YagodaCashCounts, DropCashCountExpectedCheck, YagodaIntakeTopUps, YagodaCrates, UserPasswordVault
